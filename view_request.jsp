...
<div style="height:17px"></div>
        <!-- content begins -->
        		<div class="cont_top"></div>
       			<div id="content">
                	<div class="cont_home_bot">
                       ...
                       <form action="SendToServer" action="post">
                    ...
                    while(rs1.next())
                    {
                      ...
                      <tr><td>Duration</td><td><%= rs1.getString("Duration") %></td></tr>
            	  ...
            	  if(ServerConfirmation.equalsIgnoreCase("no")){
            	  %>
                       <tr><td colspan="2">&nbsp;<input type="hidden" value="<%= rs1.getString("id")  %>" name="reqID"></input></td></tr> 
                      <tr><td colspan="2"><input type="submit" value="Send To Server"/></td></tr>
            	...
            	<%
            		  ...
            		  <tr><td>User Price</td><td><%= rs1.getString("New_User_Price") %> Rs.</td></tr>
                      <tr><td colspan="2">Request Already Sent to Server.</td></tr> 
