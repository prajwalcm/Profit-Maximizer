 ...
 <%
                   // boolean Authorised=false;
                      ...
                      //  String Admin = (String)session.getAttribute("admin");
                        ...
                        ResultSet rs = st.executeQuery("select * from custrequest where Server_confirmation=1 and confirmation='Accept'");
                        while(rs.next()){
                        ...
                        float UP = rs.getFloat("New_User_Price");
                        float SP = rs.getFloat("Server_Price");
                        float Profit = UP-SP;
                            %>
                    ...
                    <tr style="text-align: center"">
                        ...
                        <td><%= user %></td>
                        <td><%= rs.getFloat("Server_Price") %></td>
                        <td><%= rs.getFloat("New_User_Price") %></td>
                        <td><%= Profit %></td>
                         <td style="display:none"><a href="view_server_response.jsp?reqID=<%= rs.getString("id") %>">Click Here</a></td>
