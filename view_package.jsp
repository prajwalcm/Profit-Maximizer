...
//                     Statement stat=conn.statementfun();
                    ...
                    String quesry2="select * from cspcloud where id="+pkgID;
                    ...
                    while(rs1.next())
                    {
                       ...
                       ResearvPrice =rs1.getString("ResearvPrice"); 
                       ResearvTime=rs1.getString("ResearvTime");
                      ...
                      <tr><td>VCPU</td><td><%=rs1.getString("vCPU")  %></td></tr> 
                      <tr><td>Memory</td><td><%=rs1.getString("memory")   %> GB</td></tr> 
                       <tr><td>Researv Price</td><td><%=rs1.getString("ResearvPrice")   %> Rs.</td></tr> 
                        <tr><td>Researv Time</td><td><%=rs1.getString("ResearvTime")   %></td></tr> 
                      <tr><td>Initial Price</td><td><%= rs1.getString("ip")  %></td></tr> 
