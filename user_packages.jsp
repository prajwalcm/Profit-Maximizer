                   ...
                   // boolean Authorised=false;
                     //  int providerid = Integer.parseInt((String)session.getAttribute("sesid"));
                      ...
                      //  String Admin = (String)session.getAttribute("admin");
                        ...
                        ResultSet rs = st.executeQuery("select * from provider_packages");
                        while(rs.next()){
                       
                        String user = GF.getProviderName(rs.getInt("provider_id"));
                    ...
                    <tr style="text-align: center"">
                        ...
                        <td><a href="purchase_package.jsp">Purchase Now</a></td>
