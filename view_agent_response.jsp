        		...
        		<div class="cont_top"></div>
       			<div id="content">
                	<div class="cont_home_bot">
                       ...
                       <form action="UserAgentToUser" action="post">
...
//                     Statement stat=conn.statementfun();
             ...
             if(AgentResp.equalsIgnoreCase("0")){
              ...
              for(int i=0;i<pac.length;i++){
            	 ...
            	 %>
            	 <a href="view_package.jsp?pkgID=<%= pac[i] %>"><%= pckName %></a>
            	 <%
            	 // out.println(pckName);
              ...
              %></td></tr> 
             <tr><td colspan="2"><input type="submit" value="Send To User"></input></td></tr> 
