...
if(request.getParameter("full")!=null){
	   out.println("<script>alert('Your Cloud Storage is full please login into backup storage...');</script>"); 
	}
       			...
       			<div id="content">
                	<div class="cont_home_bot">
                        ...
                        <div style="margin-left: auto; margin-right: auto; width:200px">
                            ...
                            <table align="center">
                             <form action="BackupLogin">
            <tr>
                <td><font size="3" color="#FFFFFF">Backup server Sign In</font> 
