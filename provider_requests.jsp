 ...
 <%
                   // boolean Authorised=false;
                      ...
                      //  String Admin = (String)session.getAttribute("admin");
                        ...
                        ResultSet rs = st.executeQuery("select * from custrequest where Server_confirmation='0'");
                        while(rs.next()){
                    ...
                    <tr style="text-align: center"">
                        ...
                        <td><%= rs.getInt("uid") %></td>
                        <td><%= status %></td>
                         <td><a href="server_view_request.jsp?reqID=<%= rs.getString("id") %>">Click Here</a></td>
