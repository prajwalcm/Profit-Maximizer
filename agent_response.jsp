 ...
 <%
                   // boolean Authorised=false;
                      ...
                      //  String Admin = (String)session.getAttribute("admin");
                        ...
                        ResultSet rs = st.executeQuery("select * from custrequest where Server_confirmation=1");
                        while(rs.next()){
                    ...
                    <tr style="text-align: center"">
                        ...
                        <td><%= rs.getString("confirmation") %></td>
                         <td><a href="view_server_response.jsp?reqID=<%= rs.getString("id") %>">Click Here</a></td>
