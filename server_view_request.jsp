        		...
        		<div class="cont_top"></div>
       			<div id="content">
                	<div class="cont_home_bot">
                        ...
                        <div class="home_box" >
                          <div class="home_box" style="width:700px; height:250px">
                        <font size="3" color="red">  Configuration requesting for </font>  
                       <form action="SendToProvider" action="post">
                    ...
                    while(rs1.next())
                    {
						...
						if(status.equals("0"))
                         ...
                         Float ProcPrice = GF.getProcPrice(Integer.parseInt(rs1.getString("Processor"))); 
						 String storage = rs1.getString("Storage");
						 int Duration = Integer.parseInt(rs1.getString("Duration"));
						 
						 float ServerPrice  = Duration * ProcPrice;
						 String eligibility="";
                     ...
                     <% if(eligibility.equalsIgnoreCase("")){
                      ...
                      <tr><td>Enter Price</td><td>Rs.<input type="text" name="ServerPrice" value="<%= ServerPrice %>"></input></td></tr>
                      
                      <tr><td colspan="2">&nbsp;</td></tr> 
            
            	  <%
            	  String ServerConfirmation = rs1.getString("Server_confirmation");
            	  if(ServerConfirmation.equalsIgnoreCase("0")){
            	  %>
                       <tr><td colspan="2">&nbsp;<input type="hidden" value="<%= rs1.getString("id")  %>" name="reqID"></input></td></tr> 
                      <tr><td colspan="2"><input type="submit" value="Send To Provider"/></td></tr>
            	
            	<%
            	  }else{
            		  
            		  %>
                      <tr><td colspan="2">Request Already Sent to Provider.</td></tr> 
